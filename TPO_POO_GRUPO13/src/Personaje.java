...
public class Personaje {
    ...
    public void usarObjeto(Personaje victima){
        ...
        if(this.Herramientas!=null) {
            ...
            List<Herramienta> herramientasRotas = new ArrayList<Herramienta>();
            ...
            for (Herramienta HerramientaUsada:this.getHerramientas()) {
                ...
                if (HerramientaUsada.getUsos() > 0) {
                    ...
                    if (HerramientaUsada.getAtributo() < 0) {
                        ...
                        defensatotald = this.getDefensa() + HerramientaUsada.getAtributo();
                    ...
                    System.out.println("El objeto " + HerramientaUsada.getNombre() + " de " + this.getNombre() + " se rompio" );
        ...
        if(daniofinal < 0){
            ...
            victima.setSalud(victima.getSalud() - this.getAtaque());
            System.out.println("--> " + this.getNombre() + " le ha infligido " + this.getAtaque() + " de danio con los punios sobre " + victima.getNombre());
        }
