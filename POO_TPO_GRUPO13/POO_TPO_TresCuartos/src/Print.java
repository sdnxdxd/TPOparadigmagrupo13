...
public class Print   {
    ...
    public static void printEstats(Personaje pj){
        System.out.println("Las estadisticas de: " + pj.getNombre().toUpperCase());
    ...
    public static void printRondas(Personaje pj){
        ...
        if(!pj.vive()) {
            ...
            System.out.println("El personaje " + pj.getNombre().toUpperCase() +  " ha subido de nivel!");
            System.out.println();
    ...
    public static void completaTodasLasRondas(Personaje personaje, int size){
        ...
        if(personaje.getRonda()-1 == size) {
            System.out.println("========== El personaje " + personaje.getNombre() + " salvo a Gotham ==========");
            System.out.println("--------------------------------------------------------");
        }
